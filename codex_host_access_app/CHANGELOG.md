...
- Bundles Bridge `0.16.1` without changing its Integration API compatibility.
...
- Keeps the optional Host Access App aligned with Codex Bridge `1.8.6`.
  Its separate host-access grants and permissions are unchanged.
