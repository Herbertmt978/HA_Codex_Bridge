...
def test_app_metadata_is_immutable_and_discovered_by_the_integration() -> None:
    ...
    assert config["options"] == {"enable_mcp": False, "enable_local_mcp": False,
                                  "enable_stdio_mcp": False, "enable_browser": False}
    assert config["schema"] == {"enable_mcp": "bool", "enable_local_mcp": "bool",
                                 "enable_stdio_mcp": "bool", "enable_browser": "bool"}
