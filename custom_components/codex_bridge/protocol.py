...
_KNOWN_PROBLEM_CODES = frozenset(
    {
        ...
        "account_profile_reauthentication_required",
        "account_profiles_unavailable",
        ...
        "chat_operations_unavailable",
        "chat_section_conflict",
        "chat_section_not_found",
        "chat_section_payload_invalid",
        "chat_section_store_unavailable",
        "navigation_revision_conflict",
        "navigation_revision_required",
        ...
        "runtime_thread_busy",
        "runtime_thread_operation_conflict",
        "runtime_thread_operation_unknown",
        "runtime_unavailable",
        "task_actions_unavailable",
        "thread_has_scheduled_automation",
        "task_host_access_denied",
        "task_id_invalid",
